...
Tips-
显态记忆
可直接调动的，以意识活动呈递出的记忆。（如切实发生过的事件等。）
隐态记忆
不可直接调动，以能力、行为间接反应出的记忆。（如知识，肌肉记忆等。）
3.思想偏正
用自身理解去分析抽象事物时，会产生适应自己的偏差。
...
3．植入人格
受非自然刺激，或因双人格协和而产生的后天回路，植入人格控制学习和感知，拥有一定的协调“自我”的能力（如自我辩驳，信仰）和一部分基本生命活动的控制权。
...
5.简练：简化表达
简笔勾勒，便表达关键信息。不拥有思维和表达的惰性的同时，也不需要冗余之物来增加信息门槛或者伪装学识渊博。不过，核心需要平凡的结构去撑起，表达核心的同时也需要重视繁琐平淡的结构。

6.相和：避免情绪
接纳不同的观点，尽可能平和中立地对待。保持情绪稳定，才能更好地观察和利用。
...
8.合理：合乎事实
认知来自实际。我们需要让我们的认知更有实际含义，以及谨慎考虑违背实际的认知。

9.协和：共同作用，共同表达
协和的事物可能在本质上相互冲突，但表观上能够同时出现和发挥作用。

10.关联：同时出现，同时消失
关联是一种较弱的关系，但这种具备不确定性的关系，可以快速被我们发觉和利用。

11.依赖:【作用和定义】依赖于另一事件或环境的【作用和定义】
即有些事物不可单独出现，但出现时又可将该物区分。例如木板在特定位置被称作门，被称作门时是指代该木板而非其他物。

12.逻辑:强调联系
当你享受某种感觉时，往往会忽视逻辑。正如因果关系是虚构的表观联系，但基于对感性，对人的社会属性的考量，我们在处理某些事物时，应依据适用于特定场合的合乎常理的引发和被引发的关系定义因果关系。

#### 二.析源手段
1.重新评估
每隔一段时间或经受重大事件后，重新判断目标对象的性质，明确知晓其对自身的价值。

2.调解
任何人都可能存在存在偏差的认知，任何事物的对立面也应该联系事物的其他特征而进行综合性的评判。在得到针对具体事物的具体回答前，允许自身思维中存在相互冲突的想法，在有绝对的具体把握之前，保证他们能和谐共存。

3.定界
对于已有信息，或自身处理的信息，应该保证其每一段描述中指代的含义和现实的含义一一对应。

4.符号
明确区分理想的符号和其在现实世界的暂时性寄托，不沉迷或过度追求现实中的某个事物。

5.有效交流
减少无意义的发言，敏锐关注交流态度，交流目的，待解决问题，延伸问题，细节暗示。比起技巧上的切磋，我们更需要越来越明朗的结果。

6.依赖性
任何事物都有其前提和基础，前提和基础一旦改变，事物允许改变。即便是许诺或者契约，在前提和基础改变后也未必要遵守。我们即需要把握现象，也需要把握本质。

7.建构
实现目标时，应从表及里建构一系列“规则”。它们包含：途径分支，目标本身，对己影响，对物影响，退出方式。同时，我们做一件事时，要考虑:个人意愿与责任，效果与执行难度，共识与替代方案，原因、目的与要求，具体行动与处理态度。

8.虚构逻辑
并不需要理解一些事物的本质和真实正确的规律。构建一种基于应付或应用的逻辑，并且在满足已知案例后不断完善。组成为：已知输入，处理回路，正确输出。 处理事物之间联系的逻辑，是最重要的虚构逻辑。

9.价值分析
事物价值(v)因对象差异产生不同的暂时性流动价值(w,v>=w)，流动价值除去运作消耗价值(s)与无法直接利用但能影响技艺状态的并行价值(m)后,剩余的价值(w-s-m)通过技艺传递及放大(被放大的价值为必要价值，即机械式模仿特定活动所具备的价值)构成积蓄价值(t,t>=w)，积蓄价值中传递出价值w2(w2=w)即为等价交换。技艺决定价值收益(t-w2)的多少,可通过流动价值的传递而改良。同一份事物价值在同一时间可产生多份不可叠加的流动价值，运作消耗价值包含运作事物本身需要消耗的价值和流动价值在传递过程中需消耗的价值。

10.取舍
为使可控的事物不至于不可控，那我们需要在应对不可控的事物的时候保持良性的心态和采取良性的行为。

11.区域分析
分析事物时，首先考虑整体的逻辑合理性。即呈现给你的信息是否是片面的，是否是有意误导的，是否是刻意虚构的。其次才是对这些信息进行逻辑分析。这需将事件划分为多个区域，分析各个区域及区域联系的合理性，来协助判断。一般的流程为：展现对方的观点，指出支持对方观点的证据，再分析这些证据，肯定有效的证据，将有瑕疵的证据转化为对自己观点有利的部分，最后表达自己的观点，提出一些转化对方观点或实现自身观点的方法。

12.感性
感性可以快速高效地调动更多的力量和做出反应，也能为我们的理性分析提供更多的材料。在感性分析时，需要接收尽可能多而全面的信息，以免立场受到繁杂的表象影响而不断改变。感性与理性从不对立，漠视规则，把不服从个人偏见的表象归结为错误是低级感性的特征，木讷死板，热烈批驳不合客观逻辑的事物是低级理性的特征。

13.信念捆绑
捆绑信念和必要工作，以达到扩大利益和实质化信念进而稳定收益的目的。例如利用一些高端词汇来设立虚职，在镇压真相的同时谋私。

14.神经网络模型
神经网络模型以人类的智慧统合世界的智慧，突破生物思维带来的局限。神经网络模型代替的是不具备思想内核或思想浅薄的简单活动，技术的发展会进一步筛除不具备超强创新力的作品。
Tips-
神经网络模型有以下功能：
1.统合已有的智慧
减少无意义的知识重叠
...
充分利用已有的成果
3.稳定安全的交互
稳定的回复风格和封闭式的交互，更能使我们持续高效地提出真实的想法，并能得到不具备社会偏见的回复。
4.协助创意和思考
知识水平和经验经历会限制我们思考的范围，不具备明显倾向性但专业的回复往往能为我们提供关键的想法。

15.提高思维能力
1.处理语言信息的速度和结果
2.处理逻辑运算的速度和结果
3.强化和描述长远记忆的能力：记忆便于形成网络化的思维
4.维持感官静态而稳定的能力
5.快速搜索指定点信息的能力
6.学习知识，分析问题，接纳理论的能力
*学习模式：从学习方式来看分为灌输式学习、自主学习、激励学习；或从学习过程来看分为分立学习、统合学习、任务性学习、持续学习）
...
17.切片
找对问题的切片，将一个复杂问题分解为多个仅需要回答是或否的判别问题。
